                  ...
                  <SectionWrapper>
                        <MaxWidthWrapper>
                              <GridWrapper className="gap-y-0">
                                    <HeroCard className="" title="Unlock Your Tech Future: Welcome to the IT Job Fair" highlight="Job Fair" desc="Embark on a Journey Towards Success as You Explore Diverse Tech Roles and Networking iOpportunities" />
